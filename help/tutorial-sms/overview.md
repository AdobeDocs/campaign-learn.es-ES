...
badgeV7V8: label = &quot;Se aplica a las versiones 7 y 8" type="Positive"
...
* **[Configuración de una cuenta SMS para un proveedor SMPP estándar](/help/tutorial-sms/set-up-account-for-standard-smpp-provider.md)**
  *Aprenda a adaptar el conector de SMS a su proveedor SMPP. Ajuste la configuración de SMS para gestionar los límites de conexión.  Obtenga información sobre cómo configurar el rendimiento máximo, la ventana de envío y el cifrado con TLS.*

* **[Adapte el conector SMS a su proveedor SMPP](/help/tutorial-sms/adapt-sms-connector-to-smpp-provider.md)**
  *Aprenda a ajustar la configuración de su SMS para gestionar los límites de conexión. Obtenga información sobre cómo configurar el rendimiento máximo, una ventana de envío y el cifrado con TLS.*

...
[!UICONTROL Audit Trail] captura en tiempo real una lista completa de las acciones y eventos que se producen en Adobe Campaign.[!UICONTROL Audit Trail] incluye una forma de autoservicio de tener acceso a un historial de datos para responder preguntas como las siguientes:
